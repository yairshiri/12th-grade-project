...
class DQN_Agent(Agent):
    ...
    def __init__(self, env):
        ...
        if self.hyperparameters['replay buffer']['type'].lower() == 'per':
            self.memory = Memory.Prioritized_Memory(min_buffer_size, max_buffer_size, batch_size)
        elif self.hyperparameters['replay buffer']['type'].lower() == 'uer':
            self.memory = Memory.Uniform_replay(min_buffer_size, max_buffer_size, batch_size)
